...
const ProjectDetailsModal = ({ project, onClose }) => {
  // If no project selected, don't render anything
  ...
  // We use createPortal to render this OUTSIDE the current DOM hierarchy
  // directly into document.body. This ensures it covers the full screen.
  return createPortal(
    <AnimatePresence>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <motion.div
          ...
          className="bg-sand-50 w-full max-w-4xl rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] relative z-10"
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-6 md:p-10">
            ...
            <div className="mb-8 mt-4">
              <span
                className={`inline-block px-4 py-2 rounded-full text-sm font-bold uppercase tracking-wider shadow ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
              ...
              <div className="p-4 bg-white rounded-2xl border border-sand-200">
                ...
                <p className="font-bold text-earth-900">
                  ₹{project.allocated_budget?.toLocaleString("en-IN")}
                </p>
                <p className="text-sm text-earth-900/60">
              ...
              <div className="p-4 bg-white rounded-2xl border border-sand-200">
                ...
                <div className="flex justify-between text-sm">
                  <div>
                    <span className="block text-earth-900/40 text-xs">
                      Start
                    </span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-sand-100/50 rounded-3xl p-6 border border-sand-200">
                ...
                <div className="space-y-3">
                  <p className="font-bold text-lg text-earth-900">
              ...
              <div className="bg-sand-100/50 rounded-3xl p-6 border border-sand-200">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3 opacity-50">
                    ...
                    <span className="text-sm text-earth-900/50">
            ...
            {project.images && project.images.length > 1 && (
              <div className="mt-10">
                <h3 className="font-serif font-bold text-xl text-earth-900 mb-4">
                  Site Photos
                </h3>
    ...
    document.body // This is the key fix: render directly to body
  );
};
